...
commands = [
    ...
    f"snbmodules_multiru_multisnb_gen -n --detector-readout-map-file {cfg_dir}/medium_scale_system_DetReadoutMap.json -c {cfg_dir}/large_scale_system_with_snbmodules.json test",
]
