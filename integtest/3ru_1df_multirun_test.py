...
resval.cpu_count_needs(30, 60)  # 3 for each data source (incl TPG) plus 3 more for everything else
resval.free_memory_needs(20, 32)  # 25% more than what we observe being used ('free -h')
