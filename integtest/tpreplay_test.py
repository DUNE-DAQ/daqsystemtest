...
resval.cpu_count_needs(6, 12)  # 3 for ConnSvc threads plus 3 more for everything else
resval.free_memory_needs(3, 4)  # 50% more than what we observe being used ('free -h')
