...
resval.require_cpu_count(12)  # 3 for ConnSvc threads plus 3 more for everything else; overall safety factor of 2
resval.require_free_memory_gb(4)  # double what we observe being used ('free -h')
resval.require_total_memory_gb(8)  # 4x what we need; trying to be kind to others
