...
resval.require_cpu_count(8)  # 2 for each data source plus 2 more for everything else; overall safety factor of 2
resval.require_free_memory_gb(6)  # double what we observe being used ('free -h')
resval.require_total_memory_gb(12)  # 4x what we need; trying to be kind to others
