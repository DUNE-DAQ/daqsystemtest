...
resval.cpu_count_needs(4, 8)  # 2 for each data source plus 2 more for everything else
resval.free_memory_needs(4, 6)  # 33% more than what we observe being used ('free -h')
