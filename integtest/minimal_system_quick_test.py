...
resval.cpu_count_needs(6, 12)  # 2 for each data source plus 2 more for everything else
resval.free_memory_needs(5, 8)  # 25% more than what we observe being used ('free -h')
