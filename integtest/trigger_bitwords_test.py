...
resval.cpu_count_needs(15, 30)  # 3 for each data source (incl TPG) plus 3 more for everything else
resval.free_memory_needs(9, 14)  # 30% more than what we observe being used ('free -h')
